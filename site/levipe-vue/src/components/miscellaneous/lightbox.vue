<template>
    <div>
      <a href="#" @click.prevent="show" class="w-full">
          <figure :style="'background-image:url('+thumbnail+');background-position: 50% 0px;'" class="w-16 h-16 md:w-24 md:h-24 lg:w-32 lg:h-32 bg-cover rounded-full shadow-md" />
      </a>
