...
import pushbuttonList from './components/search/pushbutton-list.vue'
...
new Vue({
    ...
    components: { swal, lvpVariant, lvpCart, lvpMinicart, StarRating, autocompleteSearch, pushbuttonList }
});